...
<c:if test="${not empty developmentMap}">
                    ...
                    <table class="developments_table">
                        ...
                        <c:forEach items="${entry.value}" var="listItem">
                            <tr>
                                ...
                                <td class="table_element">
                                    <input form="delete" type="checkbox" name="developmentsId" value="${listItem.id}">
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
    ...
    <form:form id="delete" method="get" action="<%=Constants.REMOVE_DEVELOPMENT_MAPPING%>"/>
    <form:form id="additionally" method="get" action="<%=Constants.SHOW_DEVELOPMENT_DETAILS_MAPPING%>">
